...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        print('unet_use_cross_frame_attention:', unet_use_cross_frame_attention)
        print('unet_use_temporal_attention:', unet_use_temporal_attention)
    ...
    def from_pretrained_2d(cls, pretrained_model_path, subfolder=None, unet_additional_kwargs={}):
        ...
        model_file = os.path.join(pretrained_model_path, 'unet.pth')
        # print(model_file)
